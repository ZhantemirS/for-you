...
const slides = [
  { time: 0, image: "image1.jpg", text: "Давным давно две расы правили Землей: ЛЮДИ и МОНСТРЫ." },
  { time: 7, image: "image2.jpg", text: "Но однажды между ними вспыхнула война." },
  { time: 13, image: "image3.jpg", text: "После продолжительной битвы людям удалось одержать победу." },
  { time: 24, image: "image4.jpg", text: "И с помощью волшебного заклятия они заключили монстров под землю." },
  { time: 29, image: "image5.jpg", text: "ГОРА ЭБОТТ, 201Х" },
  { time: 34, image: "image6.jpg", text: "Легенды гласят, что те, кто взобрался на гору, никогда не возврашались." },
  { time: 39, image: "image7.jpg", text: "И мы оба знаем, что происходит дальше." },
  { time: 46, image: "image8.jpg", text: "" },
  { time: 52, image: "image9.jpg", text: "" },
  { time: 58, image: "image10.jpg", text: "" },
  { time: 60, image: "image11.jpg", text: "И мы начали общаться" },
  { time: 62, image: "image12.jpg", text: "В том самом ММ" },
  { time: 64, image: "image13.jpg", text: "" },
  { time: 66, image: "image14.jpg", text: "В ВК" },
  { time: 68, image: "image15.jpg", text: "а позже в телеграмме" },
  { time: 70, image: "image3.jpg", text: "и теперь, мы тут." },
  { time: 74, image: "image3.jpg", text: "Я люблю тебя, Сонь" },
